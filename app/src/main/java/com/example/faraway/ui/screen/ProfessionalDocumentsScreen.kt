...
fun DocumentosScreen(navController: NavController? = null) {
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(DocBackground) // Fundo azul claro
            .padding(16.dp)
    ...
    Box(
        ...
        Box(
            modifier = Modifier
                ...
                .offset(x = 4.dp, y = (-10).dp) // Move para fora do padding de 12.dp
        ...
        Icon(
            ...
            modifier = Modifier
                ...
                .offset(y = (9).dp) // Ajuste para mover a lixeira um pouco para cima (ou para baixo com valor positivo)
                .size(20.dp)
                .clickable { onDelete() }
        )
    }
